...
var ContentEditable = React.createClass({
    ...
    shouldComponentUpdate: function(nextProps) {
        var el = this.contentEditable;
        if (el && (nextProps.html !== el.innerHTML)) {
    ...
    componentDidUpdate: function() {
        ...
        if (this._range) {
            selectionRange(this.contentEditable, this._range)
            delete this._range
        }
    },
    ...
    render: function() {
        ...
        return React.createElement(tagName, {
            ...
            ref: function(ref) { this.contentEditable = ref; }
        });
    },
    ...
    setCursorToStart: function(){
        ...
        range.setStart(this.contentEditable, 0);
        range.collapse(true);
        sel.removeAllRanges();
        sel.addRange(range);
    },
    ...
    onPaste: function(e){
        ...
        var target = this.contentEditable
